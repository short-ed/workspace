...
function resize(event: MouseEvent) {
  ...
  const deltaSize = { width: 0, height: 0 }
...
<template>
  <div class="frame absolute" :style="cssVariables">
    <div class="border-primary resize-handle corner top-left" @mousedown="startResize($event, 'top-left')" />
    <div class="border-primary resize-handle corner top-right" @mousedown="startResize($event, 'top-right')" />
    <div class="border-primary resize-handle corner bottom-left" @mousedown="startResize($event, 'bottom-left')" />
    <div class="border-primary resize-handle corner bottom-right" @mousedown="startResize($event, 'bottom-right')" />
    <div class="after:bg-primary resize-handle edge top" @mousedown="startResize($event, 'top')" />
    <div class="after:bg-primary resize-handle edge bottom" @mousedown="startResize($event, 'bottom')" />
    <div class="after:bg-primary resize-handle edge left" @mousedown="startResize($event, 'left')" />
    <div class="after:bg-primary resize-handle edge right" @mousedown="startResize($event, 'right')" />
